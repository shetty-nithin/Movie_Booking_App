...
module.exports = (app)=>{
   ...
   app.put("/mba/api/v1/theatres/:id", [authJwt.verifyToken, theatreMiddleware.isValidParamsId, authJwt.isTheatreOwnerOrAdmin, theatreMiddleware.isValidShowTypes], theatreController.updateTheatre);
   app.delete("/mba/api/v1/theatres/:id", [authJwt.verifyToken, theatreMiddleware.isValidParamsId, authJwt.isTheatreOwnerOrAdmin], theatreController.deleteTheatre);
   ...
   app.put("/mba/api/v1/theatres/:id/movies", [authJwt.verifyToken, theatreMiddleware.isValidParamsId, authJwt.isTheatreOwnerOrAdmin], theatreController.updateMoviesInTheatre);
}