...
module.exports = (app) => {
    app.post("/mba/api//movies",[authJwt.verifyToken, authJwt.isAdmin, movieMiddleware.isValidReleaseStatus, movieMiddleware.isValidGenre], movieController.createMovie);
